            ...
            <div class="button-inner">
                ...
                <div class="inner-amount">
                    ...
                    <div class="amount-value">
                        <span v-if="generalRain && generalRain.site && generalRain.site.amount">{{rainFormatValue(generalRain.site.amount).split('.')[0]}}</span><span v-if="generalRain && generalRain.site && generalRain.site.amount">.</span><span v-if="generalRain && generalRain.site && generalRain.site.amount">{{rainFormatValue(generalRain.site.amount).split('.')[1]}}</span>
