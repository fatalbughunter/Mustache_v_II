...
const actions = {
    ...
    generalSocketConnectionError({ commit, getters }) {
        // Set default settings if connection fails to prevent infinite loading
        if(getters.generalSettings === null) {
            ...
            commit('general_set_settings', defaultSettings);
        }
    },
