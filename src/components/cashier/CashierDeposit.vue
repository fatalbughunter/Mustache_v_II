            ...
            <div class="address-input">
                <transition name="fade" mode="out-in">
                    ...
                    <div v-else class="input-content" key="data">
                        <input v-model="cashierCryptoData.addresses[selectedCurrency]" type="text" readonly />
        ...
        <div class="deposit-qrcode">
            <transition name="fade" mode="out-in">
                ...
                <div v-else class="qrcode-content" key="data">
                    <QRCode v-bind:value="cashierCryptoData.addresses[selectedCurrency]" v-bind:options="{ width: 200, height: 200, margin: 1 }" />
                </div>
            </transition>
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            modalCopyButton() {
                ...
                el.value = this.cashierCryptoData.addresses[this.selectedCurrency];
        ...
        watch: {
            'cashierCryptoData.prices': {
                handler() {
                    ...
                    if(this.cashierCryptoData.prices && this.cashierCryptoData.prices[this.selectedCurrency]) {
