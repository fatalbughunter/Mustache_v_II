...
<style>
    ...
    footer#footer .top-info::after {
        ...
        top: 0;
        right: 0;
        background: linear-gradient(0deg, transparent 50%, var(--bg-secondary) 50%), linear-gradient(0deg, rgba(255, 107, 0, 0) 0%, var(--accent-yellow) 50%, rgba(255, 107, 0, 0) 100%);
    ...
    @media only screen and (max-width: 950px) {
        ...
        footer#footer .top-info::after {
            ...
            top: 0;
            left: 0;
            border-top: 1px dotted var(--accent-yellow);
        }
