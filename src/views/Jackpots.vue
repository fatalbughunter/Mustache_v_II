            ...
            <div class="coming-soon-content">
                <div class="icon-wrapper">
                    <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M60 20 L75 50 L110 55 L85 75 L90 110 L60 90 L30 110 L35 75 L10 55 L45 50 Z" 
                              stroke="url(#copperGradient)" 
                              stroke-width="4" 
                              fill="none"
                              opacity="0.8"/>
                        <circle cx="60" cy="60" r="25" stroke="url(#copperGradient)" stroke-width="3" fill="url(#copperGradient)" opacity="0.3"/>
                        <circle cx="60" cy="60" r="12" fill="url(#copperGradient)"/>
                        <defs>
                ...
                <h1 class="coming-soon-title">JACKPOTS</h1>
