            ...
            <div class="coming-soon-content">
                <div class="icon-wrapper">
                    <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="60" cy="60" r="55" stroke="url(#copperGradient)" stroke-width="4" stroke-dasharray="8 8" opacity="0.6"/>
                        <circle cx="60" cy="60" r="40" stroke="url(#copperGradient)" stroke-width="3" stroke-dasharray="6 6" opacity="0.4"/>
                        <path d="M40 50 L50 60 L40 70 M80 50 L70 60 L80 70" stroke="url(#copperGradient)" stroke-width="4" stroke-linecap="round"/>
                        <circle cx="60" cy="60" r="8" fill="url(#copperGradient)"/>
                        <defs>
                ...
                <h1 class="coming-soon-title">SLOTS</h1>
